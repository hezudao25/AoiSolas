...
class AoisolaspiderSpider(scrapy.Spider):
    name = "AoiSola"
    allowed_domains = ["www.mm131.com", "img1.mm131.me", "www.mm131.net", "wxt.sinaimg.cn"]
    start_urls = ['https://www.mm131.com/xinggan/',
                  'https://www.mm131.com/qingchun/',
                  'https://www.mm131.com/xiaohua/',
                  'https://www.mm131.com/chemo/',
                  'https://www.mm131.com/qipao/',
                  'https://www.mm131.com/mingxing/'
                  ]
    ...
    def parse(self, response):
        ...
        for img in list:
            ...
            yield scrapy.Request(imgurl2, callback=self.content, meta={'parent_url': imgurl2}, dont_filter=True)  # 设置dont_filter=True 使所有的requests都可以执行
